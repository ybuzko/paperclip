...
import { printClaudeclawGatewayStreamEvent } from "@paperclipai/adapter-claudeclaw-gateway/cli";
...
const claudeclawGatewayCLIAdapter: CLIAdapterModule = {
  type: "claudeclaw_gateway",
  formatStdoutEvent: printClaudeclawGatewayStreamEvent,
};
